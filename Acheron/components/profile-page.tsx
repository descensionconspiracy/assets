      ...
      return {
        ranger: (
          <div className="space-y-4">
            <p>
              <span className="title">THERE IS NO REDEMPTION.</span> In the streets of New York, she is a ghost that doesn't know it's dead.
              By day, she is a woman who forgets her own address, who stands mesmerized by the rain, and who sometimes has to be reminded by a stranger to eat.
              <br/><br/>Her body remembers how to fight—the muscle memory of a thousand kendo drills is a stubborn thing—yet she is terribly human. She bleeds. She tires.
              She can be <strong>broken</strong>.
            </p>
            <p>
              <span className="title">THERE IS NO CORRUPTION.</span> Bosenmori is the quiet woman at the end of the bar who never speaks. 
              She is the shadow that stands in the alley just after the deal goes wrong, 
              or observes constructions in the city outskirts crumble 
              beneath their poorly planned architecture—who cares, they're fucking poor anyway—seemingly drawn to disaster.
              <br/><br/>She is the forgotten tenant in a crumbling Queens apartment who sometimes has to be let in because she forgot her keys,
              and often winds up sleeping in the streets as a result.
            </p>
            <p>
              <span className="title">NOTHING MATTERS. ALL FADES.</span> She wanders the streets of New York because the currents 
              of supernatural events have dragged her here. The city is a nexus of stagnant stories. 
              <b> Kindred</b> clinging to an eternity they hate, bound spirits unable to let go, of mortals locked in cycles of violence 
              and despair, obsessed with terrible sin. <br/><br/>The universe is a river, flowing inexorably towards a silent sea of nothingness. She does not hunt them with malice, much less righteousness; 
              her very being is drawn to these knots in the reality, to these puddles of stagnant water, 
              compelled to provide the release of a final, clean end. 
            </p>
          </div>
        ),
        bio: (
          ...
          <p>
            <b>DEMEANOR</b> Loner. She is quiet, distant, and forgetful. She is a stranger to herself, so she sees no point in being known by others.
          </p>
          <p>
            <b>WEAPON</b> 180 cm/70 inch-long Ōdachi. A long, red Japanese blade. She is quite attached to it.
          </p>
          <p>
            <b>COMMON BELONGINGS</b> A photo of her and a man wearing a ridiculous cartoon costume. A wooden carving of a bear.
          </p>
          <p>
        ...
        verse: (
          <div className="space-y-4">
            <p>
              <span className="title">THERE WAS AN ISLAND.</span> The memory is a sliver of glass under the skin—a sharp, persistent pain you forget is there until you press on it. 
              A people of the Izumo island, maybe, hidden in the misty folds of Hokkaido where the boundaries between the reality and the astral were thin. 
              They were a chantry of mages who believed reality was a quilt that needed constant mending. <br/><br/>She was a girl then. 
              Her father, a man of two worlds, would don the goofy mask of "Swordmaster HOMU," a cartoon hero, 
              to make their ancient traditions a game of joy and love. 
              It is the last warm thing she can remember.
            </p>
            <p>
              Their world was dying to the slow, grinding erosion of the modern age. The Technocracy called it progress; 
              her people called it the coming of a great silence. 
              They were a reality deviation, a pocket of magic and belief that the new Consensus could not tolerate, 
              for they were seen as a risk to the adaptation of mages in the modern age. 
            </p>
            <p>
              The elders, in their infinite, terminal wisdom, chose to resist. 
              They would perform one great ritual to eternalize themselves into the Astral, into beings of pure thought. To do this, they needed a focus. A battery. 
              They chose Mei.
            </p>
            <p>
              She stood at the center of it all, the anchor for a future that would never come. And the universe, in its infinite, crushing indifference, laughed. The ritual didn't mend the veil; it ripped it wide open and shoved her soul through. 
              <br/><br/>Her Awakening wasn't an ascension. It was a fall into the Big Quiet, the absolute, silent, screaming nothingness of the Abyss. 
              Their names, their faces, their stories, all scoured from the memory of the world. 
              <br/><br/>What was left of Mei was just the echo of a scream in an empty room. What walked away was a sole, nameless survivor,
              clutching a few trinkets: a hair tie, a worn-out sword, a photo of a man in a dumb mascot suit, all which proved she was ever anybody at all.
            </p>
          </div>
        ),
      }
      ...
      bio: (
        <div className="space-y-2">
          <p>
            ...
            and{" "}
            <MoreInfo className="acolor" info="The Chinese underworld.">
              Huángquán
            </MoreInfo>
            .
          </p>
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-1">
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsList className="hidden md:grid w-full grid-cols-4 gap-1 bg-transparent h-auto p-0">
                  <TabsTrigger
                    value="ranger"
                  ...
                  >
                    ...
                    <span className="hidden lg:inline xl:hidden">{verse === "ghost" ? "Digital" : "Emanator"}</span>
