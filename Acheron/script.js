...
<span class="more-info"
   ...
   It is said the first of them was forged from the bpdy of the first beast slain by the people of Izumo: the Sovereign of Revelation.">Edict
    Edges.</span>
    ...
    function updateVerse(verse) {
        ...
        moreInfoElements.forEach((element) => {
            ...
            element.addEventListener("mouseleave", () => {
                ...
                popup.forEach((p) => { p.style.visibility = "hidden"; p.style.opacity = 0; })
            })
        })
    }
