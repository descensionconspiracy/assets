      ...
      >
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-gray-300 italic mb-2 opacity-90 font-['D-DIN'] transition-all duration-500">
            <span className="text-[#b21919] transition-colors duration-300">The Woman in Gray</span> •{" "}
            <span className="text-[#7c5cff] transition-colors duration-300">Master of the Blade</span>
          </p>
          <p className="text-sm md:text-base text-gray-400 opacity-80 font-['D-DIN'] transition-all duration-500">
            "A wanderer who has lost her past to{" "}
            <span className="text-[#b21919] transition-colors duration-300">fading memories</span>"
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-8">
          ...
          >
            ...
            <span className="relative z-10 flex items-center">ENTER CELESTIA'S CROSSING</span>
          </Button>
        </div>
      </div>
    </div>
